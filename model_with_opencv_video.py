...
model.load_state_dict(torch.load("G:/9th _semister/topics in cs/project/base4/saved_model/model1.pth"))
...
# load the video from pc
# remove vid3
vid = cv2.VideoCapture("G:/9th _semister/topics in cs/project/base4/videos/vid8.mp4")
